...
export default function ResumePage(){
    ...
    return(
        <main className={styles.container}>
            ...
            style={{ border: 'none' }}
        ></iframe> */}
        <object data="/images/Resume.pdf" type="application/pdf" width="100%" height="100%" style={{minHeight: '600px', minWidth: '300px'}}>
  <p>It appears you don't have a PDF plugin for this browser. No biggie... you can <a href="/images/Resume.pdf" target="_blank" rel="noopener noreferrer">click here to download the PDF file.</a></p>
</object>
